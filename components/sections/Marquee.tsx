...
const MARQUEE_ITEMS: MarqueeItemType[] = [
  ...
  { type: "image", src: "/images/method-saas.png", alt: "Build SaaS", rotate: 3 },
  { type: "text", content: "build" },
  { type: "image", src: "/images/method-products.png", alt: "Digital Products", rotate: -1 },
  { type: "text", content: "your" },
  { type: "image", src: "/images/razorpay-proof.png", alt: "Proof", rotate: 2 },
  { type: "text", content: "income" },
  { type: "image", src: "/images/method-coaching.png", alt: "Coaching", rotate: -3 },
  { type: "text", content: "from" },
  { type: "image", src: "/images/method-affiliate.png", alt: "Affiliate", rotate: 1 },
